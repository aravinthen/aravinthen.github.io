...
* Started implementing a transformer from scratch.
...
### Weekly Architecture - Transformer
1. I started implemnting a transformer today. I've carved out what I expect the transformer to look like, but it'll be a bit of actual programming before I get there. 
2. Feeling a little too ill to go all in today, I'm afraid. This will have to wait till later in the week.  
