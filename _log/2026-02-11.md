...
7. It's interesting to note that RL lib specifies the policy and its transitions directly. A policy evaluator class is provided and this also implies a separation between actor and learner. 
