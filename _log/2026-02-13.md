...
* There are multiple levels towards RL development - this can quite clearly be seen in how the libraries that I've been reading about over the last week have been developed. I think it would be very beneficial to have a handle on all of these methods of RL development, so I think I'm going to integrate this into the general way in which I proceed with RL algorithm development. 